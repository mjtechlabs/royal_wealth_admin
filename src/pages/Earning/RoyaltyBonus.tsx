...
const RoyaltyBonus = () => {
  const [royaltyBonusData, setRoyaltyBonusData] = useState<IncomeListApiData[] | null>([])
  const loaderRef = useRef<AppLoaderRef>(null)
  const dataWithIndex = royaltyBonusData?.map((item, index) => ({
    id: index + 1,
    ...item
  }))
  ...
  return (
    <Layout2 singleLineContent={English.E32}>
