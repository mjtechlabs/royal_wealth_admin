...
const DirectReferral = () => {
  const [directBonusData, setDirectBonusData] = useState<IncomeListApiData[] | null>([])
  const loaderRef = useRef<AppLoaderRef>(null)
  const dataWithIndex = directBonusData?.map((item, index) => ({
    id: index + 1,
    ...item
  }))
  ...
  return (
    <Layout2 singleLineContent={English.E166}>
